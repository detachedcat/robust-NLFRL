...
class VelocityOnPolicyRunner(MjlabOnPolicyRunner):
  """PPO velocity runner with checkpoint env-state persistence and ONNX export."""

  env: RslRlVecEnvWrapper

  def _export_policy_to_onnx(self, path: str, filename: str = "policy.onnx"):
    """Export actor to ONNX (compatible with forked rsl_rl ActorCritic)."""
  ...
  def save(self, path: str, infos=None):
    ...
    # Use rsl_rl save (writer/logger_type); skip mjlab save (expects self.logger).
